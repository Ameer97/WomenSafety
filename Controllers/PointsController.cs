...
namespace WomenSafety.Controllers
{
    public class PointsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Lat,Lan,Description,TypeId,Name,Geom")] Point point)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Lat,Lan,Description,TypeId,Name,Geom")] Point point)
        {
            if (id != point.Id)
            {
                return NotFound();
